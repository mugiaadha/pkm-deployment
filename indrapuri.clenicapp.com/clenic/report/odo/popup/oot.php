...
<center><h5>SURAT PESANAN OBAT OBAT TERTENTU</h5></center>
<div class="w3-row">
...
$kodesup = $_GET['kodesup'];
 ...
 $alamat=$rowsx['ADDRESS1']."<br>".$rowsx['ADDRESS2'];
   ...
   <p style="font-size: 12px">Alamat(Apoteker) : Puri/Pati</p>
    ...
    <div class="w3-col s6 w3-tiny">
        <span class="w3-right">
            <br>
         <p style="font-size: 15px">Mengajukan pesanan obat obat tertentu (OOT) Kepada :</p>
 ...
 <p style="font-size: 15px">Dengan Obat Obat Tertentu(OOT) yang di pesan adalah  :</p>
...
<div class="w3-row-padding w3-tiny">
   <p style="font-size: 15px">Obat Obat Terntentu (OOT) tersebut akan di gunakan untuk :</p> 
         <p style="font-size: 12px">Nama Sarana : RS.BHINA BHAKTI HUSADA </p>
      <p style="font-size: 12px">Alamat Sarana : Jl.P.Sudirman No 9 Margorejo Pati</p>
     <p style="font-size: 12px">No.Ijin Sarana : 440/2415-1/2017</p>        
    <!-- <div class="w3-col s6">
