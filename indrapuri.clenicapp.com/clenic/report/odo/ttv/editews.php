...
$sql="UPDATE ERMEWSWAKTU set jam='$jam',menit='$menit' where notrans='$notrans' and nolembar='$nolembar' and jamx='$x'";
...
$sqls ="UPDATE ERMEWSHASILFIX set rr='$rr', rrx='$x', rry='$rry', sat='$sat', satx='$x', saty='$saty', ao='$ao', aox='$x', aoy='$aoy', alat='$alat', alatx='$x', alaty='$alaty', temp='$temp', tempx='$x', tempy='$tempy', td='$td', tdx='$x', tdy='$tdy', hr='$hr', hrx='$x', hry='$hry', lk='$lk', lkx='$x', lky='$lky', gd='$gd', 
                       gdx='$x', gdy='$gdy', totalskor='$totalskor', totalskorx='$x', totalskory='$totalskory', sn='$sn', snx='$x', sny='$skornyeriy', uo='$uo', uox='$x', uoy='$uoy', fm='$fm', fmx='$x', fmy='$freky',tdd='$tdd',tddy='$tddy'
