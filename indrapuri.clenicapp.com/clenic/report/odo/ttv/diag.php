...
$sqlrt = "SELECT      *
FROM            ERMTTVDIAG
WHERE        (nolembar = '$nolembar')  AND (ketx = '$x') AND (kety = '$y') and notrans='$notrans' ";
$paramsrt = array();
...
?>
    ...
    <form  action="svdiag.php" method="POST">
...
<table>
  <tr>
<td>
     <label class='w3-label w3-text'>Diagnosa/Penunjang </label>
</td>
<td>

    <textarea name="obat" placeholder="Diagnosa/Penunjang" ></textarea>
...
?>
    ...
    <form  action="editdiag.php" method="POST">
...
<td>
<!--    <input type="text" name="obat" value="<?php  echo $rowsrt['ket']?>" placeholder="Diagnosa/Penunjang" required>
 -->
   <textarea name="obat" placeholder="Diagnosa/Penunjang" ><?php  echo $rowsrt['ket']?></textarea>
