...
$sql="INSERT INTO ERMIBSMONITORINGANESTESITGL (tanggal, x, y, notransibs, notrans, status
)
...
$sqlx="INSERT INTO ERMIBSMONITORINGANESTESITGL (tanggal, x, y, notransibs, notrans, status
)
...
}else if(isset($_POST['simpan23'])){


$sqls = "SELECT * FROM  ERMRUMUSANASTESI where  angka ='".$_POST['nadi']."' and status='TN' ";
  ...
  while( $rows = sqlsrv_fetch_array( $stmts, SQLSRV_FETCH_ASSOC) ) 
  {
    ...
    $sqlx="INSERT INTO ERMIBSMONITORINGANESTESITGL (tanggal, x, y, notransibs, notrans, status
        ...
        VALUES ('".$_POST['nadi']."','".$_POST['x']."','".$rows['garis']."','".$_POST['notransibs']."','".$_POST['notrans']."','NADI')";
$sqlqx=sqlsrv_query($conn,$sqlx);
  ...
  $sqls = "SELECT * FROM  ERMRUMUSANASTESI where  angka ='".$_POST['resp']."' and status='RR' ";
  $stmts = sqlsrv_query( $conn, $sqls );
  while( $rows = sqlsrv_fetch_array( $stmts, SQLSRV_FETCH_ASSOC) ) 
  {
    ...
    $sqlx="INSERT INTO ERMIBSMONITORINGANESTESITGL (tanggal, x, y, notransibs, notrans, status
        ...
        VALUES ('".$_POST['resp']."','".$_POST['x']."','".$rows['garis']."','".$_POST['notransibs']."','".$_POST['notrans']."','RESP')";
$sqlqx=sqlsrv_query($conn,$sqlx);
...
$sqls = "SELECT * FROM  ERMRUMUSANASTESI where  angka ='".$_POST['sis']."' and status='TN' ";
  $stmts = sqlsrv_query( $conn, $sqls );
  while( $rows = sqlsrv_fetch_array( $stmts, SQLSRV_FETCH_ASSOC) ) 
  {
        ...
        VALUES ('".$_POST['sis']."','".$_POST['x']."','".$rows['garis']."','".$_POST['notransibs']."','".$_POST['notrans']."','TDS')";
$sqlqx=sqlsrv_query($conn,$sqlx);
...
$sqls = "SELECT * FROM  ERMRUMUSANASTESI where  angka ='".$_POST['dis']."' and status='TN' ";
  $stmts = sqlsrv_query( $conn, $sqls );
  while( $rows = sqlsrv_fetch_array( $stmts, SQLSRV_FETCH_ASSOC) ) 
  {
        ...
        VALUES ('".$_POST['dis']."','".$_POST['x']."','".$rows['garis']."','".$_POST['notransibs']."','".$_POST['notrans']."','TDD')";
$sqlqx=sqlsrv_query($conn,$sqlx);
...
{
  ?>
  <form  action="tglibs.php" method="POST">
  ...
  <form  action="tglibs.php" method="POST">
    ...
    <div class='w3-row'>
      <div class='w3-col'>
        ...
        <input type="text" maxlength="3" name="nadi" placeholder="Nadi" >
      </div> 
      <div class='w3-col'>
        <label class='w3-label w3-text'>Resp </label>
        <input type="text" maxlength="2" name="resp" placeholder="Resp " >
      </div> 

       <div class='w3-col'>
        <label class='w3-label w3-text'>Sistole </label>
        <input type="text" maxlength="3" name="sis" placeholder="Sistole " >
      </div> 

       <div class='w3-col'>
        <label class='w3-label w3-text'>Distole </label>
        <input type="text" maxlength="3" name="dis" placeholder="Distole " >
      </div> 

    </div>
    <br>
    <button type="submit" name="simpan23" class="btn w3-red">Simpan</button>
    <button type="button" class="btn w3-green" data-dismiss="modal">Batal</button>
  </form>
  <?php
}
else if($id === 'isigrafik')
{
  $arr = ['anastesi','operasi'];
  ?>
  ...
  <form  action="tglibs.php" method="POST" class="__selection" id="anastesi" style="display: none;">
    <input type='hidden' name='notrans' value="<?php echo $notrans ?>">
    <input  type='hidden' name='notransibs' value="<?php echo $notransibs ?>">
    <input  type='hidden' name='kduser' value="<?php echo $kduser ?>">
    <input type='hidden' name='x' value="<?php echo $x ?>">
    ...
    <div class='w3-row'>
      <div class='w3-col'>
        ...
        <input type="text" value="X" name="tanggal" placeholder="Anastesi " required>
      </div>
    </div>
    <br>
  ...
  <form  action="tglibs.php" method="POST" class="__selection" id="operasi" style="display: none">
    <input type='hidden' name='notrans' value="<?php echo $notrans ?>">
    <input  type='hidden' name='notransibs' value="<?php echo $notransibs ?>">
    <input  type='hidden' name='kduser' value="<?php echo $kduser ?>">
    <input type='hidden' name='x' value="<?php echo $x ?>">
    ...
    <div class='w3-row'>
      <div class='w3-col'>
        ...
        <input type="text" value="O" name="tanggal" placeholder="Operasi " required>
      </div>
    </div>
    <br>
