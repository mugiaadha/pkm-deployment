...
$status = $_GET['status'];
 ...
 header("Content-Disposition: attachment; filename=Stok-obat $tgldari - $tglsampai.xls");
...
$query="SELECT 
a.*,b.gudang,c.obat
FROM obatstock a , gudang b,obat c
WHERE a.kdgudang = b.kdgudang AND a.kdobat = c.kdobat AND
a.kdcabang = '$kdcabang' order by c.obat asc";
...
FROM obatstock a , gudang b,obat c
WHERE a.kdgudang = b.kdgudang AND a.kdobat = c.kdobat AND
a.kdcabang = '$kdcabang' and a.kdgudang='$kdgudang' order by c.obat asc";
