            ...
            <table>
              <tr>
                ...
                <td style="color:black;">
                  ...
                  <br>
               <a href="labarugiklinikexx.php?kdcabang=<?php echo $kdcabang ?>&tgldari=<?php echo $tgldari ?>">Export Excel</a>
                </div>
...
WHERE kdcoa BETWEEN '401.001' AND '401.100' and kdcabang='$kdcabang'
 AND   MONTH(tgl)='$bulan' AND YEAR(tgl)='$tahun'
 ORDER BY kdcoa asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
...
<tr class='details' style='border-bottom: 0.5px solid grey;'>
<td>-PENDAPATAN DARI LUAR</td>
<td>          <?php
                  $query="SELECT SUM(jml) AS total FROM glpusatd

WHERE kdcoa BETWEEN '402.001' AND '402.100' and kdcabang='$kdcabang'
 AND   MONTH(tgl)='$bulan' AND YEAR(tgl)='$tahun'
 ORDER BY kdcoa asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
...
WHERE kdcoa BETWEEN '510.000' AND '510.100' and kdcabang='$kdcabang'
 AND   MONTH(tgl)='$bulan' AND YEAR(tgl)='$tahun'
 ORDER BY kdcoa asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
...
WHERE kdcoa BETWEEN '520.000' AND '520.100' and kdcabang='$kdcabang'
 AND   MONTH(tgl)='$bulan' AND YEAR(tgl)='$tahun'
 ORDER BY kdcoa asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
...
WHERE kdcoa BETWEEN '530.000' AND '530.100' and kdcabang='$kdcabang'
 AND   MONTH(tgl)='$bulan' AND YEAR(tgl)='$tahun'
 ORDER BY kdcoa asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
...
WHERE kdcoa BETWEEN '540.000' AND '540.100' and kdcabang='$kdcabang'
 AND   MONTH(tgl)='$bulan' AND YEAR(tgl)='$tahun'
 ORDER BY kdcoa asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
...
WHERE kdcoa BETWEEN '550.000' AND '550.100' and kdcabang='$kdcabang'
 AND   MONTH(tgl)='$bulan' AND YEAR(tgl)='$tahun'
 ORDER BY kdcoa asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
...
WHERE kdcoa BETWEEN '560.000' AND '560.100' and kdcabang='$kdcabang'
 AND   MONTH(tgl)='$bulan' AND YEAR(tgl)='$tahun'
 ORDER BY kdcoa asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
