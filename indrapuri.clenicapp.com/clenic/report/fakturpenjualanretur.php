...
<hr>
        <div style="text-align: center;font-size:11px;">FAKTUR RETUR PENJUALAN<br>
...
WHERE a.norm = b.norm AND a.kdcabang = b.kdcabang AND a.noretur='$noretur'
AND a.kdkostumer = c.kdkostumerd and a.kdcabang='$kdcabang' and a.stsr='1' and a.totaluangr > 0";
...
WHERE a.kdobat = b.kdobat AND a.kdcabang =b.kdcabang AND a.notransaksi ='$notransaksi' AND a.kdcabang='$kdcabang' and a.statusr='1'";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                      ...
                      echo "<tr class='service'>
                                ...
                                <td class='tableitem'><p class='itemtext'>".$row['qtyr']."</p></td>
                                <td class='tableitem'><p class='itemtext'>".number_format($row['harga'])."</p></td>
                                  <td class='tableitem'><p class='itemtext'>".number_format($row['totalhargar'])."</p></td>
                            </tr>";
