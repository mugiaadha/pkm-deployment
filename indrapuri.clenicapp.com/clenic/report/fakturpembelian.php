      ...
      <table>
            ...
            <table>
              ...
              <?php
                  ...
                  WHERE a.KDSUPPLIER = b.kdsup AND a.KDCABANG = b.kdcabang
                   and a.kdcabang='$kdcabang' and c.kdgudang = a.KDGUDANG and c.kdcabang = a.kdcabang and
                  a.NOFAKTUR ='$nofaktur' and a.NOLPB='$nolpb' order by a.NOFAKTUR asc";
                  $result=mysqli_query($conn, $query);
              ...
              ?>
                 ...
                 <tr style="border: 1px solid #000; border-radius: 10px;padding: 7px;">
                  <td>
                  <span>  No Faktur&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $nofaktur ?> </span><br>
                  <span>  Supplier&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                    <?php echo $supplier ?>
                   </span><br>
                  ...
                  <span>Tgl Faktur Beli : <?php echo $tglfaktur ?> </span><br>
        ...
        <tr class="heading">
          ...
          <td>Total</td>
            ...
            $query="SELECT * from beliobatd where NOFAKTUR='$nofaktur' and nolpb='$nolpb' and kdcabang='$kdcabang' order by nomor asc";
                    $result=mysqli_query($conn, $query);
                  while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
         ...
         <td>".$row['QTY']."</td>
         <td>".$row['DISCPERSEN']."</td>
         <td>".number_format($row['DISCRP'],2)."</td>
         <td>".number_format($row['TOTAL'],2)."</td>
          ...
          border:dashed grey 1px;padding: 2px;">
            ...
            <b>Total Setelah PPN : </b>Rp. <?php echo number_format($TOTAL,2) ?> <br>
            <b>Biaya Admin : </b>Rp. <?php echo number_format($ADM,2) ?>  <br>
            <b>Netto : </b>Rp. <?php echo number_format($NETTO,2) ?> <br>
