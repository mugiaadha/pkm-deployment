...
$kdobat= strtoupper($data->obat);  
$aturan= strtoupper($data->aturan); 
$satuan= $data->satuan; 
$qty= $data->qty; 
...
$kdcabangf = 'TM'.$kdcabang.$angka;
 ...
 $conn -> query("INSERT INTO tplaningr(kdtamplated,kdtamplate , kddokter , 
    nama , kdobat , obat , aturan,qty,
    satuan,keterangan,status,kdcabang) 
 values('$kdtamplate','$kdcabangf','$kddokter','$nama','','$kdobat','$aturan','$qty','$satuan','$keterangan','$status','$kdcabang')");



  $conn -> query("DELETE FROM tplaningr where nama=''");
