...
$stssimpan = $data->stssimpan;
 ...
 $isPeriksaPkg=$data->isPeriksaPkg ?? 'N';
...
// where kdcabang='$kdcabang' and norm='$norm' ";
 ...
 values('$no_trans','$norm','$tgldaftar','$kduser','$tgl','$kdpoli','0','$kdklinik','$kdcabang')");
  ...
  $conn -> query("INSERT INTO kunjunganpasien(norm,kdpoli,tglpriksa,kddokter,kdkostumerd,jammasuk,notransaksi,koreksierm,kelas,kdklinik,kdcabang,nofaktur,isPeriksaPkg) 
 values('$norm','$kdpoli','$tgldaftar','$kddokter','$kdkostumer','$tgl','$no_trans','BELUM','$kelas','$kdklinik','$kdcabang','$no_trans','$isPeriksaPkg')");
...
where kdcabang='$kdcabang' and norm='$norm' ");
 ...
 values('$no_trans','$norm','$tgldaftar','$kduser','$tgl','$kdpoli','0','$kdklinik','$kdcabang')");
  ...
  $conn -> query("INSERT INTO kunjunganpasien(norm,kdpoli,tglpriksa,kddokter,kdkostumerd,jammasuk,notransaksi,koreksierm,kelas,kdklinik,kdcabang,nofaktur,isPeriksaPkg) 
 values('$norm','$kdpoli','$tgldaftar','$kddokter','$kdkostumerd','$tgl','$no_trans','BELUM','$kelas','$kdklinik','$kdcabang','$no_trans','$isPeriksaPkg')");
