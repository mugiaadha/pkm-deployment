...
$query="SELECT 
a.norm,a.kdpoli,a.tglpriksa,a.kddokter,a.kdkostumerd,a.notransaksi,a.isPeriksaPkg,b.pasien,b.tgllahir,c.noantrian,
d.nampoli,d.idsatusehat as locationid,e.namdokter,f.nama,g.costumer,b.alamat,g.kdtarif,a.kelas,a.koreksierm,g.dash,d.sts,b.noasuransi,d.kdpolibpjs,e.kddokterbpjs,DATE_FORMAT(a.tglpriksa, '%d-%m-%Y') as tgldaftar,a.spcare,a.nokunjungan,a.skunjungan,a.jeniskunjungan,b.tandapengenal,b.nopengenal,b.kdprovider,b.hp,g.kdkostumer,b.idpasien,c.idsatusehat,e.idhis,
b.jeniskelamin,a.kdtkp,a.ri,d.status,c.noantrianbpjs,b.kdkelurahan
     ...
     "spcare"  => $row['spcare'],
      ...
      "idsatusehat" =>$row['idsatusehat'],
       ...
       "jeniskelamin" =>$jk,
        ...
        "ri"=>$row['ri'],
        "status"=>$row['status'],
        "noantrianbpjs"=>$row['noantrianbpjs'],
          "kdkelurahan"=>$row['kdkelurahan'],
          "isPeriksaPkg"=>$row['isPeriksaPkg'],
);
