...
$conn -> query("INSERT INTO obat(kdobat
    ...
    ,kemasand
    ,kdklinik
    ,kdcabang,kdcp,kdbs,zataktifasli,kdobatbpjs,kdobatsatusehat) 
 ...
 '$bentuks','$zataktif','$data->kdobatbpjs','$data->kdobatsatusehat')");
...
$conn -> query("UPDATE obat set obat='$obat'
    ...
    ,kdobatbpjs='$data->kdobatbpjs',kdobatsatusehat='$data->kdobatsatusehat'
