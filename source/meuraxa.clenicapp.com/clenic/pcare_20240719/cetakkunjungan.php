...
@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@100;200;300;400&display=swap');
  ...
  <body>
  	    ...
  	    $noRujukan = $_GET['nokunjungan'];
                  ...
                  $query="SELECT 
a.*,b.tgllahir,b.jeniskelamin,TIMESTAMPDIFF (YEAR, b.tgllahir, CURDATE())  AS umur
    ...
    <div class="invoice-box">
      <table>
        <tr class="top">
         ...
         <div> <b>Data Kunjungan Puskesmas / Dokter Keluarga</b></div>
    <table style="border:1px solid black;">
    	 ...
    	 <tr >
    	 	 ...
    	 	 <td >
                  ...
                  <b>No Kunjungan:<b> <?php echo $noRujukan ?> 
...
<span>Diagnosa : <?php echo $nmDiag ?> (<?php echo $kdDiag ?>)</span><br>
