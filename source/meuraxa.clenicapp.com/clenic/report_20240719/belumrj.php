            ...
            <table>
              <tr>
                ...
                <td style="color:black;">
                  ...
                  <br>
                   <a href="belumrjex.php?kdcabang=<?php echo $kdcabang ?>&tgldari=<?php echo $tgldari ?>&tglsampai=<?php echo $tglsampai?>">Export Excel</a>
...
a.notransaksi = b.notransaksi AND b.norm = c.norm AND b.kdpoli = d.kdpoli
 and a.tgltransaksi BETWEEN '$tgldari' AND '$tglsampai' AND a.kdcabang='$kdcabang' AND a.ri='0'
