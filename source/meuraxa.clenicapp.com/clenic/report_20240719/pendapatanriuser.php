              ...
              <tr>
                <td class="title">
                 ...
                 <b><?php echo $namaklinik ?></b><br>
                   ...
                   <b>LAPORAN PENDAPATAN RAWAT INAP</b><br>
                   <b>Username : <?php echo $user ?></b>
...
a.notrans = b.notransaksi AND c.kdkostumerd = a.kdkostumer  AND a.norm = d.norm  AND b.kdkamar = e.kdkamar  AND  f.kdkelas = b.kdklas  AND   g.kd = a.jenistransaksi 
 and  a.tglfaktur BETWEEN '$tgldari' AND '$tglsampai' AND a.kdcabang='$kdcabang' and a.user='$user' order by a.tglfaktur ASC";
