...
$tgl = date("Y-m-d");
 ...
 header("Content-Disposition: attachment; filename=Pendapatan-rj $tgldari - $tglsampai.xls");
...
WHERE a.kdpoli = b.kdpoli  and e.kd = a.jenistransaksi
 AND a.kdcabang = b.kdcabang AND a.kdkostumer = c.kdkostumerd AND a.norm = d.norm and a.kdcabang='$kdcabang' and a.tglfaktur between '$tgldari' and '$tglsampai'  AND a.tagihan <> 0  order by b.kdpoli,a.tglfaktur asc";
...
FROM transaksiakhir a,poliklinik b , kelompokkostumerd c,pasien d,jenisbayar e
WHERE a.kdpoli = b.kdpoli  and e.kd = a.jenistransaksi
 AND a.kdcabang = b.kdcabang AND a.kdkostumer = c.kdkostumerd AND a.norm = d.norm  and a.kdcabang='$kdcabang' and a.tglfaktur between '$tgldari' and '$tglsampai' and b.kdpoli='$kdpoli'  AND a.tagihan <> 0  order by b.kdpoli,a.tglfaktur asc";
