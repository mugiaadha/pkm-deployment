...
?>
    ...
    <form  action="svkontraksi" method="POST">
 ...
 <div class='w3-row'>
                          <div class='w3-col'>
                                     ...
                                     <label class='w3-label w3-text'>Jumlah Kontraksi </label>
                             
                               <select name='jmlkontraksi' class='w3-select w3-padding'>
             <?php

include '../../config.php';

$sqls = "SELECT * FROM   ERMVKRUMUS where ket='kontraksi' order by ynilai";
 ...
 <div class='w3-row'>
                          <div class='w3-col'>
                                     ...
                                     <label class='w3-label w3-text'>Lamanya Kontraksi (Detik) </label>
                            
                            <input type='text' name='kontraksi'  placeholder='Detik' class='w3-input w3-tiny w3-border-0' required>
