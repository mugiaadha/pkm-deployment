...
$sqlsd = "SELECT top 1 *  FROM  ERMEWSHASILFIXL where  notrans='$notrans' and nolembar='$nolembar' order by tanggal desc";
...
<svg height="1330" width="991" style="background: url(tblpewsc.jpg) no-repeat 0 0;border: 1px solid black" >
   <text x='105' y='20' fill='transparent' style='font-size: 12px'>
...
$sqlsd = "SELECT * FROM  ERMEWSTGLL where  notrans='$notrans' and nolembar='$nolembar' ";
 $stmtsd = sqlsrv_query( $conn, $sqlsd );
...
$sqlsd = "SELECT * FROM  ERMEWSWAKTUL where  notrans='$notrans' and nolembar='$nolembar' order by jamx";
 $stmtsd = sqlsrv_query( $conn, $sqlsd );
while( $rowsd = sqlsrv_fetch_array( $stmtsd, SQLSRV_FETCH_ASSOC) ) {
...
<!-- RR -->
 ...
 <polyline points=
"<?php
$sqls = "SELECT * FROM  ERMEWSHASILFIXl where  notrans='$notrans' and nolembar='$nolembar' order by rrx ";
...
<circle cx='103' cy='975' r='4'   fill='black' />
<circle cx='103' cy='993' r='4'   fill='black' />



<circle cx='103' cy='1029' r='4'   fill='black' />
<circle cx='103' cy='1047' r='4'   fill='black' />
<circle cx='103' cy='1065' r='4'   fill='black' />



<circle cx='103' cy='1083' r='4'   fill='black' />
<circle cx='103' cy='1101' r='4'   fill='black' />




<circle cx='103' cy='1122' r='4'   fill='black' />
<circle cx='103' cy='1140' r='4'   fill='black' />
<circle cx='103' cy='1158' r='4'   fill='black' />

<circle cx='103' cy='1176' r='4'   fill='black' />
<circle cx='103' cy='1194' r='4'   fill='black' />
<circle cx='103' cy='1212' r='4'   fill='black' />


<circle cx='103' cy='1230' r='4'   fill='black' />
<circle cx='103' cy='1248' r='4'   fill='black' />
 -->

 <?php  


$sqlsd = "SELECT * FROM  ERMEWSHASILFIXl where  notrans='$notrans' and nolembar='$nolembar' order by rrx ";
 $stmtsd = sqlsrv_query( $conn, $sqlsd );
while( $rows = sqlsrv_fetch_array( $stmtsd, SQLSRV_FETCH_ASSOC) ) {
...
$yao2=$rows['so2y']+20;
$xao2=$rows['so2x'];
echo "<circle cx='".$xao2."' cy='".$yao2."' r='4'   fill='black' />";
echo "<text x='".$xao2."' y='".$yao2."' fill='red' style='font-size: 11px;'>".$rows['so2']."</text>";
...
echo "<circle cx='".$rows['nyerix']."' cy='".$rows['nyeriy']."' r='4'   fill='black' />";

echo "<circle cx='".$rows['urinex']."' cy='".$rows['uriney']."' r='4'   fill='black' />";

echo "<circle cx='".$rows['lochiax']."' cy='".$rows['lochiay']."' r='4'   fill='black' />";
