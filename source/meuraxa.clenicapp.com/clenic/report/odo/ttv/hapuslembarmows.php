...
if(isset($_POST['simpan'])){
 ...
 $sql2 ="DELETE ERMEWSWAKTUP  where notrans = '$notrans' and nolembar='$nolembar'";
$outp=sqlsrv_query($conn,$sql2);




 $sql2x ="DELETE ERMEWSNOLEMBARP  WHERE        (notrans = '$notrans') AND (status = 'MOWS') AND (nolembar = '$nolembar')";
$outp=sqlsrv_query($conn,$sql2x);
 ...
 $sql2xx ="DELETE ERMEWSHASILFIXP  WHERE   
