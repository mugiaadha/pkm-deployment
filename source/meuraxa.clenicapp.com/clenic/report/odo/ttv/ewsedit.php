...
data-nolembar='<?php echo $nolembar?>' data-kduser='$kduser'
...
while( $rowsd = sqlsrv_fetch_array( $stmtsd, SQLSRV_FETCH_ASSOC) ) {
  ...
  echo "<text x='".$rowsd['x']."' y='".$rowsd['y']."' fill='black' style='font-size: 12px;font-style: bold'>

  <a data-x='105' data-y='20' data-notrans='".$notrans."' data-norm='".$norm."'
data-nolembar='".$nolembar."' data-kduser='".$kduser."'
     data-toggle='modal' fill='black' data-target='#tanggal' >".date_format($rowsd['tanggal'],'Y-m-d')."</a>
