...
@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@100;200;300;400&display=swap');
            ...
            <table>
              <tr>
                ...
                <td style="color:black;">
                  <div>
                  LAPORAN PEMBAYARAN PIUTANG <br> <?php echo $tgldari ?> - <?php echo $tglsampai ?>  
                  <br>
               <a href="lappembayaranpiutangex.php?kdcabang=<?php echo $kdcabang ?>&tgldari=<?php echo $tgldari ?>&tglsampai=<?php echo $tglsampai?>">Export Excel</a>
                </div>
 ...
 <td >Tgl Bayar</td>
          <td style="text-align:left">Notrans</td>
...
AND a.tglbayar BETWEEN '$tgldari' and '$tglsampai'

GROUP BY a.notrans,a.tglbayar
order by a.tglbayar,b.pasien";
...
$kurang = $row['totalutang'] -  $row['totalbayar'];
...
<td >".number_format($row['totalutang'])."</td>
