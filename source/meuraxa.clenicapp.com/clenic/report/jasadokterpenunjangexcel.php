              ...
              <tr>
                <td class="title">
                 ...
                 <b><?php echo $namaklinik ?></b><br>
                   ...
                   <b>LAPORAN JASA DOKTER PENUNJANG</b>
...
a.jasa, a.kdpoli,b.nampoli,a.kddokter,c.namdokter,e.nama,x.norm,f.pasien,x.kdkostumerd,g.nama as kom,a.kdkomponen
 FROM transaksijasa a,kunjunganpasien x,poliklinik b ,dokter c ,tarifdetail e,pasien f,kelompokkostumerd g,komponentarif h
  ...
  x.norm = f.norm AND a.kdcabang = f.kdcabang AND

  a.kdkomponen = h.kdkomponen  
   AND h.dokter='1' AND a.tgltransaksi BETWEEN '$tgldari' AND '$tglsampai' AND a.kdcabang='$kdcabang'  and a.kdpoli='$kdpoli' ORDER BY a.tgltransaksi ASC";
...
a.jasa, a.kdpoli,b.nampoli,a.kddokter,c.namdokter,e.nama,x.norm,f.pasien,x.kdkostumerd,g.nama as kom,a.kdkomponen
 FROM transaksijasa a,kunjunganpasien x,poliklinik b ,dokter c ,tarifdetail e,pasien f,kelompokkostumerd g,komponentarif h
  ...
  a.kdproduk = e.kdtarif AND a.kdcabang = e.kdcabang and
  x.kdkostumerd = g.kdkostumerd AND x.kdcabang = g.kdcabang AND 
  x.norm = f.norm AND a.kdcabang = f.kdcabang AND   a.kdkomponen = h.kdkomponen AND h.dokter='1'  and a.kddokter='$status' AND a.tgltransaksi BETWEEN '$tgldari' AND '$tglsampai'  and a.kdpoli='$kdpoli' AND a.kdcabang='$kdcabang'  ORDER BY a.tgltransaksi ASC";
...
a.jasa, a.kdpoli,b.nampoli,a.kddokter,c.namdokter,e.nama,x.norm,f.pasien,x.kdkostumerd,g.nama as kom
 FROM transaksijasa a,kunjunganpasien x,poliklinik b ,dokter c ,tarifdetail e,pasien f,kelompokkostumerd g
  ...
  a.kdproduk = e.kdtarif AND a.kdcabang = e.kdcabang and
  x.kdkostumerd = g.kdkostumerd AND x.kdcabang = g.kdcabang AND 
  x.norm = f.norm AND a.kdcabang = f.kdcabang AND a.kdkomponen='3' AND a.tgltransaksi BETWEEN '$tgldari' AND '$tglsampai' AND a.kdcabang='$kdcabang'  and a.kdpoli='$kdpoli' ORDER BY a.tgltransaksi ASC";
...
a.jasa, a.kdpoli,b.nampoli,a.kddokter,c.namdokter,e.nama,x.norm,f.pasien,x.kdkostumerd,g.nama as kom
 FROM transaksijasa a,kunjunganpasien x,poliklinik b ,dokter c ,tarifdetail e,pasien f,kelompokkostumerd g
  ...
  a.kdproduk = e.kdtarif AND a.kdcabang = e.kdcabang and
  x.kdkostumerd = g.kdkostumerd AND x.kdcabang = g.kdcabang AND 
  x.norm = f.norm AND a.kdcabang = f.kdcabang AND a.kdkomponen='3' and a.kddokter='$status' AND a.tgltransaksi BETWEEN '$tgldari' AND '$tglsampai'  and a.kdpoli='$kdpoli' AND a.kdcabang='$kdcabang'  ORDER BY a.tgltransaksi ASC";
