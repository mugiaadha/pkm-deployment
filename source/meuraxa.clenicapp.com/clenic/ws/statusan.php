...
$hariku ='rabu';
 ...
 $hariku ='sabtu';
     ...
     $sql = "SELECT
     c.kddokterbpjs,b.nampoli,c.namdokter,e.$hariku as jadwalpraktek
...
AND a.kddokter = c.kddokter  AND a.kddokter = e.kddokter AND a.kdpoli = e.kdpoli     and a.norm <>''
and a.rirj is null
 ORDER BY a.noantrian ASC ";
  ...
  $total = $l['total'] ;
   ...
   $sqlv = "SELECT
a.noantrian,c.kddokterbpjs,b.nampoli,c.namdokter,e.$hariku as jadwalpraktek,f.kodeantrian

FROM antrian a,poliklinik b,dokter c,jadwalpraktek e,dokterklinik f
WHERE a.kdpoli = b.kdpoli AND b.kdpolibpjs='".$kdpoli."' AND a.tglpriksa='".$tglpriksa."'
and c.kddokterbpjs='".$kddokter."'
 AND a.status='SELESAI' and a.kdpoli= f.kdpoli and a.kddokter =f.kddokter
AND a.kddokter = c.kddokter  AND a.kddokter = e.kddokter AND a.kdpoli = e.kdpoli    and a.norm <>''
and a.rirj is null
...
$data[] = array(
                'namapoli' => $d['nampoli'],
            'totalantrean' => $total ,
            'sisaantrean' => $sisaantreanv,
            'antreanpanggil' => $kodeantrian.$antrianpgl,
