...
$ket10a=$data->ket10a;
    ...
    $sql="SELECT * from kajianresep where notransaksi='$notrans' ";
...
$ket6b=$data->ket6b;
    ...
    $sql="SELECT * from kajianresepb where notransaksi='$notrans' ";
...
$analis=$data->analis;
    $sql="SELECT * from kajianresepc where notransaksi='$notrans' ";
