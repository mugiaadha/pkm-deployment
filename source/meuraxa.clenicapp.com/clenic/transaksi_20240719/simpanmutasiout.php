...
$user = $data->user;
    ...
    $sqlsaldo="SELECT * from mutasiout where nomutasi='$nomutasi'
...
$nomutasi = $nomutasi;
 ...
 $conn -> query("UPDATE mutasiout set keterangan='$keterangan' where nomutasi='$nomutasi' and  kdcabang='$kdcabang' ");
   ...
   $nomutasix = 'MUTOUT-'.$kdcabang.$form_no.'-'.$angka;



  $conn -> query("INSERT INTO mutasiout(nomutasi,tgl,kdsuplier,kdgudang,user,kdcabang,keterangan) 
...
$qty = $data->qty;
     ...
     $sql="SELECT nomor from mutasioutd where nomutasi='$nomutasi' and kdcabang='$kdcabang'";
  ...
  $conn -> query("INSERT INTO mutasioutd(nomutasi,nomor,kdobat,qty,kdcabang) 
 ...
 $sqlsaldo="SELECT * from kartustok where KDBARANG='$kdobat' and KDGUDANG='$kdgudang' 
  and kdcabang='$kdcabang' and NOFAKTUR='$nomutasi' and STSMUTASI='MUTOUT'";
...
$conn -> query("INSERT INTO kartustok(KDBARANG,NOMOR,NOFAKTUR,KDCUS,TGLDATE,
   ...
   values('$kdobat','$nomor','$nomutasi','$kdsuplier','$tgl','$kdgudang','MUTOUT','$qty','$kdcabang')");
...
$conn -> query("INSERT INTO saldoobat(kdbarang,kdgudang,FSBLAIN_KELUAR,KDCABANG) 
...
$qty = $data->qty;
     ...
     $conn -> query("DELETE from mutasioutd where kdcabang='$kdcabang' 
    and nomutasi='$nomutasi' and nomor='$nomor' and kdobat='$kdobat'");


     $conn -> query("DELETE from kartustok where kdcabang='$kdcabang' 
    and NOFAKTUR='$nomutasi' and nomor='$nomor' and KDBARANG='$kdobat' and  STSMUTASI='MUTOUT'");
...
$nomutasi = $data->nomutasi;
 ...
 $conn -> query("DELETE from mutasiout where kdcabang='$kdcabang' 
