...
if($stssimpan === '1'){
 ...
 $kdperawat = $data->kdperawat;
    ...
    $sql="SELECT nomor from transaksipasiend where nofaktur='$notransaksi' and kdcabang='$kdcabang' and kdpoli='$kdpoli'
...
$ri=$data->ri;
 ...
 values('$notransaksi','$nofaktur','$tgltransaksi','$tgltransaksi','$nomor','$kdproduk','$produk','$kdpoli','$qty','$harga','$debet','$kridit','$jenistransaksi','$tarifasli','$disc','$kdcabang','$user','$ri')");




$sqljasa="SELECT * from tarifkomponen where kdtarif='$kdproduk' and kdcabang='$kdcabang'  and kdkomponen<>'6'";
...
$hargakom =  $rowjasa['harga'];
  ...
  $conn -> query("INSERT INTO transaksijasa(notrans,nofaktur,nomor,kdkomponen,kdpoli,kdproduk,kddokter,tgltransaksi,jasa,kdcabang,qty) 
 values('$notransaksi','$nofaktur','$nomor','$kdkom','$kdpoli','$kdproduk','$kdperawat','$tgltransaksi','$hargakom','$kdcabang','1')");
...
$kk = $netto + $kridit;
  ...
  $conn -> query("DELETE FROM transaksipasiend where notransaksi='$notransaksi' and nomor='$nomorx' and kdproduk='$kdproduk' 
    and kdcabang='$kdcabang' and kdpoli='$kdpoli' ");
 ...
 $conn -> query("DELETE FROM trigerbayar where notrans='$notransaksi' 
  and kdcabang='$kdcabang' ");



$conn -> query("UPDATE jualobat set statuslunas='1' ,sudahbayar=0
where nofaktur='$notransaksi' 
  and kdpoli='$kdpoli'
  and kdcabang='$kdcabang' and statuslunas='2'");
...
$conn -> query("UPDATE transaksijasa set jasa='$hargajx' ,qty='$qtyx'
 where notrans='$notransaksi' and nomor='$nomorx' and kdproduk='$kdproduk' and kdcabang='$kdcabang' and kdkomponen='$kdkomx' ");
...
where nofaktur='$nofaktur' and jenistransaksi='DB' and kdcabang='$kdcabang'";
...
$conn -> query("UPDATE transaksipasiend set debet='$harganew',disc='$pengkurangdisc' where nofaktur='$nofaktur' and jenistransaksi='DB' and kdcabang='$kdcabang'  and nomor='$nm' and kdproduk='$kp'");
...
where nofaktur='$nofaktur' and kdcabang='$kdcabang'";
...
$sqljasax="SELECT * from transaksijasa  
where nofaktur='$nofaktur' and kdcabang='$kdcabang' and kdkomponen='$kdkomponen' and nomor='$nomorx' and kdproduk='$kdproduk'";
...
$conn -> close();
 ...
 $conn -> query("DELETE FROM transaksiakhir where notrans='$notransaksi' 
  and kdpoli='$kdpoli'
  and kdcabang='$kdcabang' ");
