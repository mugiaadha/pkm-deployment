...
,alergiudara='$data->alergiudara',alergiobat='$data->alergiobat',kdprognosa='$data->kdprognosa',
terapinonobat='$data->terapinonobat'
...
if($hakakses === 'Perawat'){
    ...
    ,alergiudara,alergiobat
    ) 
 values('$kduser','$notrans','$tgl','$norm','$kddokter','$kdpoli','$subjekp','$td',
 '$bb','$nadi','$suhu','$rr','$spo','$pf','$planing','$kdcabang','$alergi','$tdd',
 '$hr','$tb','$rwytp','$subjekp','$tglkontrol','$rencanatindakan','$stspulang','$skalanyeri','$imt','$riwayatdahulu','$riwayatkeluarga','$data->alergiudara','$data->alergiobat')");
...
status='SIAP' where notransaksi='$notrans' and
 kdcabang='$kdcabang' and status='ANTRI'");
       ...
       $conn -> query("INSERT INTO ermcppt(kduser,notrans,tgl,norm,kddokter,kdpoli,subjek,td,bb,nadi,suhu,rr,spo,pf,planing,kdcabang,alergi,tdd,hr,tb,rwytp,subjekp,
    tglkontrol,rencanatindakan,stspulang,skalanyeri,imt,riwayatdahulu,riwayatkeluarga
  ,alergiudara,alergiobat,kdprognosa,terapinonobat
    ) 
 ...
 '$riwayatkeluarga','$data->alergiudara','$data->alergiobat','$data->kdprognosa','$data->terapinonobat')");
