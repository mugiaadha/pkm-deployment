...
(SELECT diagnosa FROM ermcpptdiagnosa WHERE notrans=a.notransaksi AND STATUS='diagnosa' ORDER BY NO ASC LIMIT 1 ) AS diagnosa,(SELECT kddiagnosa FROM ermcpptdiagnosa WHERE notrans=a.notransaksi AND STATUS='diagnosa' ORDER BY NO ASC LIMIT 1 ) AS kddiagnosa
