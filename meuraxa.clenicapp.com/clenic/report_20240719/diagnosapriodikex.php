...
$tglsampai = $_GET['tglsampai'];
 ...
 header("Content-Disposition: attachment; filename=Diagnosa Priode  $tgldari - $tglsampai.xls");
...
,xc.city_name,f.kddiagnosa,f.diagnosa,g.kddiagnosa AS  kdtindakan,g.diagnosa AS tindakan
