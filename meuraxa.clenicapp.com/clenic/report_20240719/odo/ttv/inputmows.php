...
a.tanggal, a.notrans, a.norm, a.nolembar, rr, rrx, rry, sat, satx, saty, ao, aox, aoy, alat, alatx, alaty, temp, tempx, tempy, td, tdx, tdy, hr, hrx, hry, lk, lkx, lky, gd, 
             ...
             b.jam, menit,ekg,ekgx,ekgy,scan,scanx,scany,eskalasi,eskalasix,eskalasiy,so2,so2x,so2y
from ERMEWSHASILFIXp a , ERMEWSWAKTUp b
...
?>
 ...
 <form  action="svpws.php" method="POST">
...
<tr>
                                <td>
                                   <label class='w3-label w3-text'>EKG</label>
                                </td>
                                  <td>
                                      <input type="text"  name="ekg" placeholder="EKG" >
                                </td>
                              </tr>
...
<tr>
                                <td>
                                   <label class='w3-label w3-text'>SCAN</label>
                                </td>
                                  <td>
...
<tr>
                                <td>
                                   <label class='w3-label w3-text'>ESKALASI</label>
                                </td>
                                  <td>
                                      <input type="text"  name="eskalasi" placeholder="ESKALASI" >
                                </td>
                              </tr>
...
?>
 ...
 <form  action="editmows.php" method="POST">
...
<tr>
                                <td>
                                  ...
                                  <td>
                                      <input type="text"  value="<?php echo $rowsrt['ekg']?>"  name="ekg" placeholder="EKG" >
                                </td>
                              </tr>
...
<tr>
                                <td>
                                  ...
                                  <td>
                                      <input type="text"   value="<?php echo $rowsrt['scan']?>"  name="scan" placeholder="SCAN" >
                                </td>
                              </tr>
...
<tr>
                                <td>
                                  ...
                                  <td>
                                      <input type="text"   value="<?php echo $rowsrt['eskalasi']?>"  name="eskalasi" placeholder="ESKALASI" >
                                </td>
                              </tr>
