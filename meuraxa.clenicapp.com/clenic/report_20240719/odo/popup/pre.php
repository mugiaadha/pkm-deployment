...
<center><h5>SURAT PESANAN OBAT MENGANDUNG PREKURSOR FARMASI</h5></center>
<div class="w3-row">
...
$kodesup = $_GET['kodesup'];
 ...
 $alamat=$rowsx['ADDRESS1']."<br>".$rowsx['ADDRESS2'];
   ...
   <p style="font-size: 12px">Alamat(Apoteker) : Puri/Pati</p>
    ...
    <div class="w3-col s6 w3-tiny">
        <span class="w3-right">
            <br>
         <p style="font-size: 15px">Mengajukan Pesanan Obat Mengandung Prekursor Farmasi kepada:</p>
 ...
 <p style="font-size: 15px">Jenis Obat Mengandung Prekursor Farmasi yang di pesan adalah  :</p>
...
<div class="w3-row-padding w3-tiny">
   <p style="font-size: 15px">Obat Mengandung Prekursor Farmasi tersebut akan di gunakan memenuhi kebutuhan :</p> 
