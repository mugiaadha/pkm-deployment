...
header("Content-type: application/vnd-ms-excel");
 header("Content-Disposition: attachment; filename=HutangTempo$tgldari - $tglsampai.xls");
            ...
            <table>
              <tr>
                ...
                <td style="color:black;">
                  <div>
                  FAKTUR PEMBELIAN PRIODIK JATUH TEMPO <br> <?php echo $tgldari ?> - <?php echo $tglsampai ?> 
...
and a.kdcabang='$kdcabang' AND a.TGLJATUHTEMPO  BETWEEN '$tgldari' AND  '$tglsampai' and c.kdgudang = a.KDGUDANG and c.kdcabang = a.kdcabang and a.KDSUPPLIER='$kdsup'
and a.SYSTEMBAYAR='2'
 ...
 FROM beliobat a , suplier b,gudang c
 WHERE a.KDSUPPLIER = b.kdsup AND a.KDCABANG = b.kdcabang
and a.kdcabang='$kdcabang' AND a.TGLJATUHTEMPO  BETWEEN '$tgldari' AND  '$tglsampai' and c.kdgudang = a.KDGUDANG and c.kdcabang = a.kdcabang  
and a.SYSTEMBAYAR='2'
order by a.NOFAKTUR asc";
...
if($kds === 'true'){
 ...
 FROM beliobat a , suplier b,gudang c
 WHERE a.KDSUPPLIER = b.kdsup AND a.KDCABANG = b.kdcabang
and a.kdcabang='$kdcabang' AND a.TGLJATUHTEMPO  BETWEEN '$tgldari' AND  '$tglsampai' and c.kdgudang = a.KDGUDANG and c.kdcabang = a.kdcabang and a.KDSUPPLIER='$kdsup' and a.KDGUDANG='$status'
and a.SYSTEMBAYAR='2'
  order by a.TGLJATUHTEMPO asc";
}else{

   $query="SELECT a.*,b.nama,c.gudang
 FROM beliobat a , suplier b,gudang c
 WHERE a.KDSUPPLIER = b.kdsup AND a.KDCABANG = b.kdcabang
and a.kdcabang='$kdcabang' AND a.TGLJATUHTEMPO  BETWEEN '$tgldari' AND  '$tglsampai' 
and c.kdgudang = a.KDGUDANG and c.kdcabang = a.kdcabang and a.KDGUDANG='$status' 
and a.SYSTEMBAYAR='2'
 order by a.TGLJATUHTEMPO asc";
}
