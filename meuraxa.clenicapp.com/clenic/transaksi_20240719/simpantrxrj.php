...
$ri=$data->ri;
  ...
  $conn -> query("INSERT INTO transaksipasiend(notransaksi,nofaktur,tgltransaksi,waktu,nomor,kdproduk,produk,kdpoli,
    qty,harga,debet,kridit,jenistransaksi,tarifasli,disc,kdcabang,user,ri,kdTindakanSK) 
 values('$notransaksi','$nofaktur','$tgltransaksi','$tgltransaksi','$nomor','$kdproduk',
 '$produk','$kdpoli','$qty','$harga','$debet','$kridit','$jenistransaksi','$tarifasli','$disc',
 '$kdcabang','$user','$ri','$data->kdTindakanSK')");
