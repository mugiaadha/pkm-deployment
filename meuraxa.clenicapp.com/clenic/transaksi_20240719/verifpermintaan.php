...
$urut = $row['notransaksi'];
 ...
 $conn -> query("UPDATE  transaksipasiend set notransaksi='$no_trans' where  kdcppt='$kdcppt' and kdcabang='$kdcabang' and kdpoli='$kdpoli'");

 $conn -> query("UPDATE  transaksijasa set notrans='$no_trans' where  kdcppt='$kdcppt' and kdcabang='$kdcabang' and kdpoli='$kdpoli'");
