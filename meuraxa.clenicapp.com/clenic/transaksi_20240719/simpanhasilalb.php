...
if($stssimpan === '1'){
  ...
  $conn -> query("INSERT INTO hasillab(notrans,norm,kdgolongan,kdlab,kdproduk,hasil,username,keterangan,kdcabang,status,warna) 
 values('$notrans','$norm','$kdgolongan','$kdlab','$kdproduk','$hasil','$username','$keterangan','$kdcabang','$status','$warna')");
