...
$conn -> close();
  ...
  $conn -> query("DELETE FROM transaksipasiend where nofaktur='$nofaktur' and nomor='$nomorx' and kdproduk='$kdproduk' and kdcabang='$kdcabang' and kdpoli='$kdpoli' and kdcppt='$kdcppt' ");

  $conn -> query("DELETE FROM kunjunganpasien where nofaktur='$nofaktur'  and kdcabang='$kdcabang' and kdpoli='$kdpoli'  ");

  $conn -> query("DELETE FROM transaksipasien where notransaksi='$nofaktur'  and kdcabang='$kdcabang' and kdpoli='$kdpoli'  ");
 ...
 $conn -> query("DELETE FROM transaksijasa where nofaktur='$nofaktur' and nomor='$nomorx' and kdproduk='$kdproduk' and kdcabang='$kdcabang' and kdpoli='$kdpoli' and kdcppt='$kdcppt' ");



 $conn -> query("DELETE FROM ermcpptintruksi where notransaksi='$nofaktur' and kdpruduk='$kdproduk'
