...
$kdcabangf = 'TS'.$kdcabang.$angka;
  ...
  $conn -> query("INSERT INTO teslab(kdlab , nama , kdgolongan,golongan,kdmetode,metode,satuan,
    reflaki,refperempuan,lmin,lmax,pmin,pmax,kdcabang,nourut) 
 values('$kdcabangf','$nama','$kdgolongan','$golongan','$kdmetode','$metode','$satuan','$reflaki','$refperempuan','$lmin','$lmax','$pmin','$pmax','$kdcabang','$nourut')");
...
nama ='$nama', kdgolongan='$kdgolongan',golongan='$golongan',kdmetode='$kdmetode',metode='$metode',satuan='$satuan',
    reflaki='$reflaki',refperempuan='$refperempuan',lmin='$lmin',lmax='$lmax',pmin='$pmin',pmax='$pmax',nourut='$nourut'
