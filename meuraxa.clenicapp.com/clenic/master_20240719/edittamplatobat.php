...
$conn -> query("UPDATE tplaning set $field='$aturan' where kdcabang='$kdcabang'
 and  kdtamplated='$kdtamplated' and kdtamplate='$kdtamplate' 
  and  kddokter='$kddokter'");
