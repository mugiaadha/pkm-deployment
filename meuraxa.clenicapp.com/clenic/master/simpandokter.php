...
$nik  = $_POST["nik"];
$usericare = $_POST["usericare"];
$passicare = $_POST["passicare"];
...
$kdcabangf = 'DOK'.$kdcabang.$angka;
  ...
  $conn -> query("INSERT INTO dokter(kddokter,namdokter,statusonline,kdklinik,kdcabang,status,kddokterbpjs,nik,usericare,passicare) 
 values('$kdcabangf','$dokter','$online','$kdklinik','$kdcabang','$sn','$kddokterbpjs','$nik','$usericare','$passicare')");
...
$conn -> query("UPDATE dokter set namdokter='$dokter',aktif='$aktif',kddokterbpjs='$kddokterbpjs',
statusonline='$online',status='$sn',nik='$nik',usericare='$usericare',passicare='$passicare' where kdcabang='$kdcabang' and kddokter='$kddokter'");
 $pesan ='Berhasil Edit  ';
