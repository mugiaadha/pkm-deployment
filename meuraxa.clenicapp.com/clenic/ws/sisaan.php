...
WHERE a.kdpoli = b.kdpoli AND b.kdpolibpjs='".$kdpoli."' AND
a.tglpriksa='".$tglpriksa."' AND a.status='SELESAI' and a.rirj is null ORDER BY a.noantrian DESC LIMIT 1 ";
...
WHERE a.kdpoli = b.kdpoli AND b.kdpolibpjs='".$kdpoli."' AND a.tglpriksa='".$tglpriksa."'  AND a.norm = c.norm
 AND c.noasuransi='".$nokartu."'  and a.rirj is null AND a.kdpoli = d.kdpoli AND a.kddokter = d.kddokter";
      $query = $db->prepare( $sql );
    $query->execute();
    $d = $query->fetch();
