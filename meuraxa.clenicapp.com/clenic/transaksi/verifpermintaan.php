...
$urut = $row['notransaksi'];
 ...
 $conn -> query("UPDATE  transaksipasiend set notransaksi='$no_trans' 
 where  kdcppt='$kdcppt' and kdcabang='$kdcabang' and kdpoli='$kdpoli' and notransaksi=''");

 $conn -> query("UPDATE  transaksijasa set notrans='$no_trans' 
 where  kdcppt='$kdcppt' and kdcabang='$kdcabang' and kdpoli='$kdpoli' and notrans=''");



 $conn -> query("UPDATE  ermcpptintruksi set status='1',kunci='1' where  kdcppt='$kdcppt' and 
status='0' and
  kdcabang='$kdcabang' and kdpoli='$kdpoli'");
