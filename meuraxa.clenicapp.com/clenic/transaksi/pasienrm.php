...
,i.kodeantrian,d.kdpolibpjs,b.noasuransi,a.spcare,g.dash,c.idsatusehat,c.statusantrian
...
a.kdkostumerd = f.kdkostumerd AND f.kdkostumer = g.kdkostumer AND a.kdcabang='$kdcabang' AND a.tglpriksa BETWEEN '$tgl' and  '$tgls'
 ...
 and b.pasien like '%$nama%' and c.rirj is null and d.statussakit <> '2' order by a.kddokter,c.noantrian asc  ";
...
WHERE a.norm = b.norm 
AND a.notransaksi = c.notransaksi AND a.kdpoli = d.kdpoli AND a.kddokter = e.kddokter AND
a.kdkostumerd = f.kdkostumerd AND f.kdkostumer = g.kdkostumer AND a.kdcabang='$kdcabang' and a.tglpriksa BETWEEN '$tgl' and  '$tgls' and
b.pasien like '%$nama%'
...
a.kdkostumerd = f.kdkostumerd AND f.kdkostumer = g.kdkostumer AND a.kdcabang='$kdcabang' and a.tglpriksa BETWEEN '$tgl' and  '$tgls'
   ...
   and b.pasien like '%$nama%' and c.rirj is null and d.statussakit <> '2' and d.nampoli = '$caripoli' order by a.kddokter,c.noantrian asc  ";
