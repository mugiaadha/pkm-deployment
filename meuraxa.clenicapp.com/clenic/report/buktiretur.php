...
<hr>
        <div style="text-align: center;font-size:11px;">FAKTUR MUTASI<br>
        ...
        <p> 
          ...
          <?php
$query="SELECT 
a.nomutasi,a.tgl,a.keterangan,b.gudang AS dari,c.gudang AS ke
FROM mutasi a
INNER JOIN gudang b  ON a.kdgudangd = b.kdgudang AND a.kdcabang = b.kdcabang
INNER JOIN gudang c ON a.kdgudangke = c.kdgudang AND a.kdcabang = c.kdcabang 
