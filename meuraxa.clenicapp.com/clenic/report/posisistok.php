...
$tgl = date("Y-m-d");
 ...
 if($status === '1'){
$query="SELECT 
a.*,b.gudang,c.obat,hargabeli,hargajual
FROM obatstock a , gudang b,obat c
WHERE a.kdgudang = b.kdgudang AND a.kdobat = c.kdobat AND
a.kdcabang = '$kdcabang' order by c.obat,b.kdgudang asc";
...
FROM obatstock a , gudang b,obat c
WHERE a.kdgudang = b.kdgudang AND a.kdobat = c.kdobat AND
a.kdcabang = '$kdcabang' and a.kdgudang='$kdgudang' order by c.obat,b.kdgudang  asc";
