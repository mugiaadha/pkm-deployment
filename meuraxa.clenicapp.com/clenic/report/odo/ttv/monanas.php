...
<th>
  ...
  <select class="dokter-anes" name="dokanas" data-placeholder="Dokter Anastesi" style="width: 100%"></select>
</th>
<th>
  <b style="font-size: 18px">Perawat Anastesi </b>
  <select class="perawat-anes" name="peranas" data-placeholder="Perawat Anastesi" style="width: 100%"></select>
</th>
  </tr>
...
<table style="border-top: 1px solid black">
  <tr>
<th>
  <textarea type="text" name="konversi" placeholder="Konversi dari Regional ke General" > <?php echo $rowsrt['konversi'] ?> </textarea>
</th>
  </tr>
...
<th>
  <b style="font-size: 18px">Dokter Anastesi</b>
  <select class="dokter-anes" name="dokanas" data-placeholder="Dokter Anastesi" style="width: 100%">
  	<?php 
  	if (!empty($rowsrt['dokanas'])) 
  	{
  		echo '<option selected value="'.$rowsrt['dokanas'].'">'.$rowsrt['dokanas'].'</option>';
  	}
  	?>
  </select>
</th>
<th>
  <b style="font-size: 18px">Perawat Anastesi </b>
  <select class="perawat-anes" name="peranas" data-placeholder="Perawat Anastesi" style="width: 100%">
  	<?php 
  	if (!empty($rowsrt['dokanas'])) 
  	{
  		echo '<option selected value="'.$rowsrt['peranas'].'">'.$rowsrt['peranas'].'</option>';
  	}
  	?>  	
  </select>
</th>  	
