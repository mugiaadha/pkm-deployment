...
data-nolembar='$nolembar'
     data-toggle='modal' fill='white' data-target='#tanggal' >20XXXXXX</a>
...
echo "<text x='".$rows['tglx']."' y='".$rows['tgly']."' fill='black' style='font-size: 11px;font-style: bold'>".$rows['tanggal']."</text>";

echo "<text x='".$rows['harix']."' y='".$rows['hariy']."' fill='black' style='font-size: 11px;font-style: bold'>".$rows['harike']."</text>";

echo "<text x='".$rows['bbx']."' y='".$rows['bby']."' fill='black' style='font-size: 11px;font-style: bold'>".$rows['bb']."</text>";
...
while( $rowsd = sqlsrv_fetch_array( $stmtsd, SQLSRV_FETCH_ASSOC) ) {
  ...
  echo "<text x='".$rowsd['ketx']."' y='".$rowsd['kety']."' fill='black' style='font-size: 12px;font-style: bold'>".$rowsd['ket']."</text>";
...
<?php  
for ($y = 25; $y <= 212; $y+=14) {
  // echo "<text x='481' y='$y' fill='black' style='font-size: 10px;font-style: bold'>Kolom3</text>";
...
<?php  
for ($y = 25; $y <= 212; $y+=14) {
  // echo "<text x='625' y='$y' fill='black' style='font-size: 10px;font-style: bold'>Kolom4</text>";
...
<?php  
for ($y = 25; $y <= 212; $y+=14) {
  // echo "<text x='769' y='$y' fill='black' style='font-size: 10px;font-style: bold'>Kolom5</text>";
...
data-nolembar='$nolembar' data-kduser='$kduser'
  ...
  // echo "<text x='913' y='$y' fill='black' style='font-size: 10px;font-style: bold'>Kolom6</text>";
}?>
...
$sqlsfd = "SELECT * FROM  ERMTTVPROPASIEN where  notrans='$notrans' and nolembar='$nolembar' order by tanggal";
...
<td>".$rowsfd['hari']."</td>
<td>".$rowsfd['dinas']."</td>
<td>".$rowsfd['keterangan']."</td>
<td>".$rowsfd['username']."</td>
  <td>
<a href='hapusttvtambahanhasil.php?notrans=".$notrans."&norm=".$norm."&kduser=".$kduser."&nolembar=".$nolembar."&keterangan=".$rowsfd['keterangan']."' ><p>Hapus</p></a>
</td>
