...
@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@100;200;300;400&display=swap');
 ...
 header("Content-Disposition: attachment; filename=Penjualan Detail $tgldari - $tglsampai.xls");
            ...
            <table>
              <tr>
                ...
                <td style="color:black;">
                  <div>
                  FAKTUR PELAYANAN PERIODIK <br> <?php echo $tgldari ?> - <?php echo $tglsampai ?> 
...
a.kdobat,b.obat,a.qty,a.disc,a.discrp,a.harga,a.totalharga
FROM jualobatd a ,obat b
WHERE a.kdobat = b.kdobat AND a.kdcabang = b.kdcabang AND a.kdcabang='$kdcabang' AND a.notransaksi='$not' ORDER BY nomor";
...
<td >".$rowx['disc']."</td>
<td>".$rowx['discrp']."</td>
<td>".number_format($rowx['harga'],2)."</td>
<td>".number_format($rowx['totalharga'],2)."</td>
