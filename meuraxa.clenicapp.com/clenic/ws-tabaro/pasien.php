...
alamat,alamatsekarang,hp,tandapengenal,nopengenal,tempatlahir,golda,kdcabang,kdklinik,tgl,pendidikan,perkerjaan,noasuransi,kdasuransi) 
        values('".$no."','".$kd_desa."','".$nama."','".$tgl_lahir."','".$jk."','TIDAK TAHU','TIDAK TAHU','".$alamat."','".$alamat."','00','KTP','".$nik."','TIDAK TAHU','Tidak Tahu','".$kdcabang."','".$kdklinik."','".$tgldaftar."','TIDAK TAHU','TIDAK TAHU','".$kartu."','CUSD0032')";
